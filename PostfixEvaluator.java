...
public class PostfixEvaluator {
    ...
    /**
     * Evaluate the specified postfix expression. If an operand is
     * encountered, it is pushed onto the stack. If an operator is 
     * encountered, two operands are popped, the operator is
    ...
    /**
     * Performs integer evaluation on the single expression consisting of
